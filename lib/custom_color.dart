...
const customcolor1 = Color(0xFF394200);

CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF394200),
  customcolor1: Color(0xFF586400),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFDAEC7A),
  onCustomcolor1Container: Color(0xFF191E00),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF394200),
  customcolor1: Color(0xFFBECF61),
  onCustomcolor1: Color(0xFF2C3400),
  customcolor1Container: Color(0xFF414B00),
  onCustomcolor1Container: Color(0xFFDAEC7A),
);
